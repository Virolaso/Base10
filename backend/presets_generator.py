...
MASTERING_PRESETS_FULL = {
    ...
    "metal": create_full_preset({}, **METAL_OVERRIDE),
    "trap": create_full_preset({}, **TRAP_OVERRIDE),
    "rap": create_full_preset({}, **RAP_OVERRIDE),
    "reggaeton": create_full_preset({}, **REGGAETON_OVERRIDE),
    "pop": create_full_preset({}, **POP_OVERRIDE),
    "cd": create_full_preset({}, **CD_OVERRIDE),
    "edm": create_full_preset({}, **EDM_OVERRIDE),
    "ambient": create_full_preset({}, **AMBIENT_OVERRIDE),
    "podcast": create_full_preset({}, **PODCAST_OVERRIDE),
}
