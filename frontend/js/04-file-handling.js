...
// ============================================================
      ...
      function setFile(f, libraryId = null) {
        ...
        if (typeof window.setAiContext === "function") {
          window.setAiContext(null);
        } else {
          window.lastAnalysisData = null;
          window.dispatchEvent(new CustomEvent("analysis-updated", { detail: null }));
        }
        ...
        try {
          ...
          for (const lf of files) {
            ...
            row.addEventListener("click", () => {
              ...
              window.selectedRefFile = selectedRefFile;
